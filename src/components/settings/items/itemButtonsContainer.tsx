...
import removeItem from "@/actions/database/admin/settings/items/removeItem";
import { ItemType } from "@/types/types";
import { FaPencilAlt } from "react-icons/fa";
import { MdDelete } from "react-icons/md";


export default function ItemButtonsContainer({ item, categoryType }: { item: ItemType; categoryType : string }) {
    ...
    return (
        <>
            ...
            <ItemDialogBox isModalOpen={isModalOpen} categoryType={categoryType } setModalOpen={setModalOpen} defaultItem={item} />
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <button
                                        ...
                                        onClick={async () => {
                                            await removeItem(categoryType, item.id);
